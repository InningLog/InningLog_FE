...
class _OnboardingPage6State extends State<OnboardingPage6> {
  ...
  void _saveDebugToken() async {
    ...
    await prefs.setString('access_token', 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIyIiwiaWF0IjoxNzUyMzM2ODU3LCJleHAiOjE5NjgzMzY4NTd9.XAr-Ma0G7GsWFnF3YzQohxbE7qU16F1sqfyQFlgZ_sYWvAuuReU5QbEyEu--rXrgHZpyXAHzmLbFE7uBjdoJXQ');
    print('🪪 테스트용 토큰 저장 완료');
  }
